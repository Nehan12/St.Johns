    ...
    <div className="grid md:grid-cols-2 gap-12">
      ...
      <div>
        <h2
          ...
          style={{ color: "#3A2A23", fontFamily: "Allrounder Monument Regular, sans-serif" }}
        >
          Get in Touch
        </h2>
        ...
        <div className="space-y-8">
          {[
            {
              title: "Location",
              content: <>123 Care Street<br />Colombo, Sri Lanka 01000</>,
              icon: (
            ...
            },
            {
              ...
              content: (
                <>
                  info@stjohnspalliative.lk<br />
                  admissions@stjohnspalliative.lk
                </>
              ),
              icon: (
                <path d="M3 7l9 6 9-6v10H3V7zM3 7l9-5 9 5" />
              ),
            },
          ].map((item, i) => (
            <div key={i} className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm leading-relaxed" style={{ color: "#5C4033", fontFamily: "Rosehot, sans-serif" }}>
                  {item.content}
                </p>
              </div>
            </div>
      ...
      <div className="bg-white rounded-2xl p-8 shadow-lg border border-[#F1D1C4]">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          {[
            ...
            <div key={field.id}>
              <label className="block text-sm font-medium mb-2" style={{ color: "#3A2A23" }}>
                {field.label}
              </label>
              <input
                type={field.type}
