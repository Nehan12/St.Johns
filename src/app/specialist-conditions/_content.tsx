...
export default function SpecialistConditionsContent() {
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          <div className="text-center w-full">
            ...
            <p
              ...
              style={{ fontFamily: "Allrounder Monument Medium, sans-serif" }}
            >
              At Heritage Care, specialist care means so much more than clinical
              support – it&apos;s the art of delivering exceptional,
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            <div className="animate-fadeInUp">
              ...
              >
                Specialist Memory Care – Luminare
              </h2>
            ...
            {[
              {
                ...
                text: "Highly tailored medical care delivered by specialist teams with expertise in complex neurological and medical conditions.",
                gradient: "from-[#B85C2E] to-[#E7A98B]",
                iconPath: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z",
              },
              {
                ...
                gradient: "from-[#E7A98B] to-[#B85C2E]",
                iconPath: "M12 8c.667-2 4-2 4 0v8c0 2-3.333 2-4 0V8z",
              },
              {
                title: "Couples Care",
                text: "Supporting couples to remain together even when their care needs differ, ensuring they can stay connected.",
                gradient: "from-[#B85C2E] to-[#E7A98B]",
                iconPath: "M12 21c-4-4-8-8-8-11a4 4 0 018-4 4 4 0 018 4c0 3-4 7-8 11z",
              },
              {
