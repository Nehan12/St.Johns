...
export default function Respite() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      >
        {/* Colorful Overlay */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#1B3C53]/80 via-[#8B4513]/70 to-[#F4A460]/60"></div>
        <div className="absolute inset-0 bg-gradient-to-t from-[#1B3C53]/40 via-transparent to-[#F4A460]/30"></div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          <div className="text-center w-full">
            ...
            <p className="text-lg md:text-xl text-white max-w-3xl mt-6 md:mt-10 mx-auto px-4" style={{ fontFamily: 'Allrounder Monument Medium, sans-serif' }}>
              At Bredrock Care, we recognise that respite care can be a transformative experience, elevating your overall wellbeing, promoting recovery and enriching your quality of life.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-20 bg-gradient-to-br from-[#D2C1B6] via-[#F4A460] to-[#F5E6D3] relative overflow-hidden">
        ...
        <div className="absolute bottom-0 right-0 w-80 h-80 bg-gradient-to-tl from-[#8B4513]/20 to-transparent rounded-full translate-x-40 translate-y-40"></div>
            ...
            <div className="animate-slideInLeft">
              ...
              <div className="space-y-4">
                <div className="flex items-start group transform transition-all duration-300 hover:translate-x-2">
                  <div className="w-6 h-6 rounded-full flex items-center justify-center mr-4 mt-1 group-hover:scale-110 transition-all duration-300 bg-gradient-to-br from-[#F4A460] to-[#D2691E] shadow-lg">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" style={{ color: 'white' }}>
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                  </div>
                  <span style={{ fontFamily: 'Rosehot, sans-serif', color: '#456882' }}>Rehabilitation and post-surgery respite care</span>
                </div>
                <div className="flex items-start group transform transition-all duration-300 hover:translate-x-2" style={{ transitionDelay: '0.1s' }}>
                  <div className="w-6 h-6 rounded-full flex items-center justify-center mr-4 mt-1 group-hover:scale-110 transition-all duration-300 bg-gradient-to-br from-[#456882] to-[#8B4513] shadow-lg">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" style={{ color: 'white' }}>
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                  </div>
                  <span style={{ fontFamily: 'Rosehot, sans-serif', color: '#456882' }}>Palliative respite care</span>
                </div>
                <div className="flex items-start group transform transition-all duration-300 hover:translate-x-2" style={{ transitionDelay: '0.2s' }}>
                  <div className="w-6 h-6 rounded-full flex items-center justify-center mr-4 mt-1 group-hover:scale-110 transition-all duration-300 bg-gradient-to-br from-[#8B4513] to-[#F4A460] shadow-lg">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" style={{ color: 'white' }}>
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                  </div>
                  <span style={{ fontFamily: 'Rosehot, sans-serif', color: '#456882' }}>Holiday stays and short-term respite care</span>
                </div>
                <div className="flex items-start group transform transition-all duration-300 hover:translate-x-2" style={{ transitionDelay: '0.3s' }}>
                  <div className="w-6 h-6 rounded-full flex items-center justify-center mr-4 mt-1 group-hover:scale-110 transition-all duration-300 bg-gradient-to-br from-[#F4A460] to-[#456882] shadow-lg">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" style={{ color: 'white' }}>
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                  </div>
                  <span style={{ fontFamily: 'Rosehot, sans-serif', color: '#456882' }}>Specialist memory care support</span>
                </div>
              </div>
            </div>
      ...
      <section className="py-12 md:py-20 bg-gradient-to-br from-[#F8F9FA] via-[#F5E6D3] to-[#F4A460]/30 relative overflow-hidden">
        ...
        <div className="absolute bottom-0 right-0 w-80 h-80 bg-gradient-to-tl from-[#8B4513]/15 to-transparent rounded-full translate-x-40 translate-y-40"></div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16 animate-fadeInUp">
            ...
            <p className="text-lg md:text-xl max-w-3xl mx-auto px-4" style={{ fontFamily: 'Rosehot, sans-serif', color: '#456882' }}>
              At Bredrock Care, we are dedicated to delivering excellence in respite care, offering a truly bespoke approach tailored to your needs. Our philosophy seamlessly blends medical expertise with a commitment to world-class hospitality.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="text-center group">
              <div className="w-16 h-16 bg-gradient-to-br from-[#456882] to-[#8B4513] rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:scale-110 transition-all duration-300">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-center group">
              <div className="w-16 h-16 bg-gradient-to-br from-[#8B4513] to-[#F4A460] rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:scale-110 transition-all duration-300">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-12 md:py-20 bg-gradient-to-br from-white via-[#F8F9FA] to-[#F5E6D3] relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-72 h-72 bg-gradient-to-tr from-[#8B4513]/15 to-transparent rounded-full translate-y-36 -translate-x-36"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-[#456882]/20 to-[#8B4513]/10 rounded-lg p-6 border border-[#456882]/30 hover:shadow-lg transition-all duration-300 hover:scale-105">
              <h3 className="text-xl font-bold text-gray-900 mb-4" style={{ fontFamily: 'Allrounder Monument Regular, sans-serif' }}>
            ...
            <div className="bg-gradient-to-br from-[#8B4513]/20 to-[#F4A460]/10 rounded-lg p-6 border border-[#8B4513]/30 hover:shadow-lg transition-all duration-300 hover:scale-105">
              <h3 className="text-xl font-bold text-gray-900 mb-4" style={{ fontFamily: 'Allrounder Monument Regular, sans-serif' }}>
                Gourmet Dining
              </h3>
              <p className="text-gray-600" style={{ fontFamily: 'Rosehot, sans-serif' }}>
                Michelin-quality dining with nutritious, chef-inspired meals tailored to your dietary preferences and health needs.
              </p>
            </div>

            <div className="bg-gradient-to-br from-[#F4A460]/20 to-[#456882]/10 rounded-lg p-6 border border-[#F4A460]/30 hover:shadow-lg transition-all duration-300 hover:scale-105">
              <h3 className="text-xl font-bold text-gray-900 mb-4" style={{ fontFamily: 'Allrounder Monument Regular, sans-serif' }}>
      ...
      {/* Why Choose Bredrock Care for Respite Care */}
      <section className="py-12 md:py-20 bg-gradient-to-br from-[#F8F9FA] via-[#F5E6D3] to-[#F4A460]/20 relative overflow-hidden">
        ...
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-tl from-[#8B4513]/10 to-transparent rounded-full translate-x-48 translate-y-48"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6" style={{ fontFamily: 'Allrounder Monument Regular, sans-serif' }}>
              Why Choose Bredrock Care for Respite Care?
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center group">
              ...
              <p className="text-sm text-gray-600" style={{ fontFamily: 'Rosehot, sans-serif' }}>
                Homes designed for comfort, elegance and expert care with premium amenities and warm hospitality.
              </p>
            </div>

            <div className="text-center group">
              <div className="w-16 h-16 bg-gradient-to-br from-[#456882] to-[#8B4513] rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg group-hover:scale-110 transition-all duration-300">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              ...
              <p className="text-sm text-gray-600" style={{ fontFamily: 'Rosehot, sans-serif' }}>
                Highly skilled professionals providing tailored support with expertise in complex needs and rehabilitation.
              </p>
            </div>

            <div className="text-center group">
              <div className="w-16 h-16 bg-gradient-to-br from-[#8B4513] to-[#F4A460] rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg group-hover:scale-110 transition-all duration-300">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                </svg>
              </div>
              ...
              <p className="text-sm text-gray-600" style={{ fontFamily: 'Rosehot, sans-serif' }}>
                Tailored programmes enhancing your wellbeing throughout your stay with personalised engagement.
              </p>
            </div>

            <div className="text-center group">
              <div className="w-16 h-16 bg-gradient-to-br from-[#F4A460] to-[#D2691E] rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg group-hover:scale-110 transition-all duration-300">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-sm text-gray-600" style={{ fontFamily: 'Rosehot, sans-serif' }}>
                A commitment to excellence ensuring the unparalleled standards of care you deserve.
              </p>
            </div>
          </div>
        </div>
